...
{
	case "Exile_Trader_VehicleCustoms_BlackMarket":
	{
		_nearVehicles = nearestObjects [player, ["LandVehicle"], 50];
	};
	case "Exile_Trader_AircraftCustoms_BlackMarket":
	{
		_nearVehicles = nearestObjects [player, ["Air"], 80];
	};
	case "Exile_Trader_BoatCustoms_BlackMarket":
	{
...
if (_playerRespect > 49999.9) then
{
...
{
["NeedRespect", []] call ExileClient_gui_notification_event_addNotification;
};