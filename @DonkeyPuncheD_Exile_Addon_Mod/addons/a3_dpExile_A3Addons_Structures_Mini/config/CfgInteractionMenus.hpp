	...
	*/
	...
	class Player 
	{
		...
		class Actions 
		{
			...
			class Bury: ExileAbstractAction
			{
				title = "Bury Body";
				condition = "!(alive ExileClientInteractionObject)";
				action = "_this call ExileClient_object_player_hideCorpse";
			};
	...
	class Toilet 
	{
		...
		class Actions 
		{
			...
			{
				title = "Take a SHIT!";
				condition = "('Exile_Item_ToiletPaper' in (magazines player)) &&  ('Exile_Item_Magazine01' in (magazines player))";
				action = "[] execVM 'scripts\takeashit.sqf'";
			};
		};
	};
	class KillBoard
	{
		...
		class Actions 
		{
			class XM8LinkUP: ExileAbstractAction
			{
				title = "Link Your XM8 to KillBoard";
				condition = "('Exile_Item_XM8' in (assignedItems player)) &&  !(DPClientXM8KillLogLink)";
				action = "[] execVM 'xm8Apps\scripts\linkXM8_killlog.sqf'";
			};
		};
	};
};