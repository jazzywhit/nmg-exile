class CfgNetworkMessages
{
	...
	{
		module = "object_player";
		parameters[] = {"STRING","STRING","STRING","STRING","SCALAR","SCALAR","SCALAR","SCALAR","SCALAR","STRING","SCALAR","SCALAR"};
	};
	...
	{
		module = "object_lock";
		parameters[] = {"STRING","STRING","BOOL","STRING","STRING","SCALAR","SCALAR","SCALAR"};
	};
	class setPin
	{
		module = "object_lock";
