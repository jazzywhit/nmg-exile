/*
	Medical Mission easy/mod/difficult/hardcore - reworked by [CiC]red_ned http://cic-gaming.co.uk
...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION newmedical1_mission_emdh.sqf with invalid parameters: %1",_this];
};
