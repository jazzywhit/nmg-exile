/*
	Hatchback easy/mod - reworked by [CiC]red_ned http://cic-gaming.co.uk
...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION nedhatchback_mission_em.sqf with invalid parameters: %1",_this];
};
