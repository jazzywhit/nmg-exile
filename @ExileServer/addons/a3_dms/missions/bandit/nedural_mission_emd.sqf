/*
	Ural easy/mod/diff - reworked by [CiC]red_ned http://cic-gaming.co.uk
...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION nedural_mission_emd.sqf with invalid parameters: %1",_this];
};
...
_crate_items 		= (2 + (round (random 6)));
_crate_backpacks 	= (1 + (round (random 2)));
								};
//difficult	> to catch the 1 in 400,000 % chance it hits a perfect 4
