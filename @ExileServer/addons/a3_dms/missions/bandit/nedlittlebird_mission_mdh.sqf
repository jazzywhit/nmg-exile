/*
	Littlebird mod/difficult/hardcore - reworked by [CiC]red_ned http://cic-gaming.co.uk
...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION nedlittlebird_mission_mdh.sqf with invalid parameters: %1",_this];
};
