/*
	...
	difficult/hardcore - reworked by [CiC]red_ned http://cic-gaming.co.uk
*/

private ["_num", "_side", "_OK", "_group", "_pos", "_difficulty", "_AICount", "_veh", "_staticGuns", "_baseObjs", "_crate", "_missionAIUnits", "_missionObjs", "_msgStart", "_msgWIN", "_msgLOSE", "_missionName", "_markers", "_time", "_added", "_cleanup", "_rndlevel"];
...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION mercbase_dh.sqf with invalid parameters: %1",_this];
};
