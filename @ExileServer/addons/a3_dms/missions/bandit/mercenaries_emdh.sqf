...
private ["_num", "_side", "_OK", "_group", "_pos", "_difficulty", "_AICount", "_type", "_launcher", "_crate", "_crate_loot_values", "_missionAIUnits", "_missionObjs", "_msgStart", "_msgWIN", "_msgLOSE", "_missionName", "_markers", "_time", "_added", "_cleanup", "_crate_weapons", "_crate_weapon_list", "_crate_items", "_crate_item_list", "_crate_backpacks", "_rndlevel"];
...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION mercenaries_emdh.sqf with invalid parameters: %1",_this];
};
...
_difficulty = "easy";
_msgStart = ['#FFFF00',"A group of noob mercenaries has been spotted. Kill them and take their equipment!"];
...
_msgStart = ['#FFFF00',"A group of skilled mercenaries has been spotted. Kill them and take their equipment!"];
...
_msgStart = ['#FFFF00',"A group of hardcore mercenaries has been spotted. Kill them and take their equipment!"];
_AICount = (6 + (round (random 4)));
_crate_weapons 		= 4;
_crate_items		= 15;
_crate_backpacks	= 4;
