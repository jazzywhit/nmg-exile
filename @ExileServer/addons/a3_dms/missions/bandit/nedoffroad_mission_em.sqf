/*
	Offroad easy/mod - reworked by [CiC]red_ned http://cic-gaming.co.uk
...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION nedoffroad_mission_em.sqf with invalid parameters: %1",_this];
};
...
//moderate	> to catch the 1 in 400,000 % chance it hits a perfect 4
