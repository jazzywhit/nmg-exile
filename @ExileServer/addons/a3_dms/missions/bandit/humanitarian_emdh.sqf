...
private ["_num", "_side", "_OK", "_group", "_pos", "_difficulty", "_AICount", "_type", "_launcher", "_crate1", "_wreck", "_crate_loot_values1", "_missionAIUnits", "_missionObjs", "_msgStart", "_msgWIN", "_msgLOSE", "_missionName", "_markers", "_time", "_added", "_cleanup", "_crate_weapons", "_crate_weapon_list", "_crate_items", "_crate_item_list", "_crate_backpacks", "_rndlevel"];
...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION humanitarian_emdh.sqf with invalid parameters: %1",_this];
};
...
_difficulty = "easy";
_msgStart = ['#FFFF00',"A truck carrying humanitarian supplies has been seized by noob bandits. Stop them!"];
...
_msgStart = ['#FFFF00',"A truck carrying humanitarian supplies has been seized by experienced bandits. Stop them!"];
...
_msgStart = ['#FFFF00',"A truck carrying humanitarian supplies has been seized by hardcore bandits. Stop them!"];
