...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION lost_battalion_emdh.sqf with invalid parameters: %1",_this];
};


//setup random skill number 0-4 to give 4 options > using "floor" to give as near same chance per difficulty
