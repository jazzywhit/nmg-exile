/*
	Hunter difficult/hardcore - reworked by [CiC]red_ned http://cic-gaming.co.uk
...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION nedhunter_mission_dh.sqf with invalid parameters: %1",_this];
};
...
_msgStart = ['#FFFF00',"A Hunter is parked at a small skilled base! Go kill them and steal it"];
...
_difficulty = "difficult";
_msgStart = ['#FFFF00',"A Hunter is parked at a small hardcore base! Go kill them and steal it"];
