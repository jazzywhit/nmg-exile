...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION bandits_emdh.sqf with invalid parameters: %1",_this];
};
...
_difficulty = "easy";
_msgStart = ['#FFFF00',"A heavily armed easy bandit group has been spotted, take them out and claim their vehicle!"];
...
_msgStart = ['#FFFF00',"A heavily armed moderate bandit group has been spotted, take them out and claim their vehicle!"];
...
_msgStart = ['#FFFF00',"A heavily armed difficult bandit group has been spotted, take them out and claim their vehicle!"];
...
_msgStart = ['#FFFF00',"A heavily armed hardcore bandit group has been spotted, take them out and claim their vehicle!"];
