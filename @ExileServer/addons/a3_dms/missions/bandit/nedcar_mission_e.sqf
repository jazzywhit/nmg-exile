...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION nedcar_mission_e.sqf with invalid parameters: %1",_this];
};



//easy - left in format of random but only want easy as this is small car for noobs
_difficulty = "easy";
_msgStart = ['#FFFF00',"Terrorists with an old car have broken down. Go kill them and steal the car"];
_AICount = (3 + (round (random 4)));
