...
systemChat "Enter CURRENT safe pin:";
_pincode = 4 call ExileClient_gui_keypadDialog_show;
if(_pincode isEqualTo "")exitWith {systemChat "Aborted!";};
systemChat "Enter NEW safe pin:";
_newPinCode = 4 call ExileClient_gui_keypadDialog_show;
if(_newPinCode isEqualTo "")exitWith {systemChat "Aborted!";};
