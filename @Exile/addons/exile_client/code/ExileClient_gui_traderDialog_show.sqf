...
_traderName ctrlSetText getText(missionConfigFile >> "CfgTraders" >> (typeOf ExileClientCurrentTrader) >> "name");
...
if (getNumber (missionConfigFile >> "CfgTraders" >> (typeOf ExileClientCurrentTrader) >> "showWeaponFilter") isEqualTo 1) then
{
