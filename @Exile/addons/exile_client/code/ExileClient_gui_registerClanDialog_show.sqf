...
try 
{
	...
	_configFeeLabel ctrlSetStructuredText (parseText (format ["<t size='1.4'>%1<img image='\exile_client\texture\ui\poptab_notification_ca.paa' size='1' shadow='true' /></t>", _registrationFee]));
