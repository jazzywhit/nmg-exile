...
_respawnDelay = getvariable ["ace_medical_maxReviveTime", false];
...
missionnamespace setvariable ["RscRespawnCounter_description", "<t size='2' align='center'>UNCONSCIOUS</t>"];
