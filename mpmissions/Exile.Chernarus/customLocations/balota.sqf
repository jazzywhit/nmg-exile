...
if (true) then
{
  _this = createVehicle ["Land_Mil_Barracks", [4673.8857, 2589.5818, 1.9073486e-006], [], 0, "CAN_COLLIDE"];
  _vehicle_359 = _this;
...
if (true) then
{
  _this = createVehicle ["Land_Mil_Barracks", [5095.3579, 2231.9253, -0.021719085], [], 0, "CAN_COLLIDE"];
  _vehicle_540 = _this;
