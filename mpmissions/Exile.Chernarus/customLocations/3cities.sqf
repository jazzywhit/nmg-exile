...
if (true) then
{
  ...
  //this setVehicleInit "this setvectorup [0,0,1]";
...
if (true) then
{
  ...
  //this setVehicleInit "this allowDammage false;this enableSimulation false;";
...
if (true) then
{
  ...
  _vehicle_4884 = _this;
  //this setVehicleInit "this setvectorup [0.1,0,0]";
