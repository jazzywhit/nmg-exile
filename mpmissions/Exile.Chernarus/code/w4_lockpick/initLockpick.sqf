...
w4_add_lockpick_actions	= compile preprocessFileLineNumbers "code\w4_lockpick\functions\actions.sqf";
w4_lockpick_fnc_create_marker_client = compile preprocessFileLineNumbers "code\w4_lockpick\functions\w4_lockpick_fnc_create_marker_client.sqf";
w4_lockpick_fnc_check_under_attack = compile preprocessFileLineNumbers "code\w4_lockpick\functions\w4_lockpick_fnc_check_under_attack.sqf";
...
[] execVM "code\w4_lockpick\initCustomActions.sqf";