...
class RscDisplaySlots
{
   ...
   class Controls
   {
     ...
     class spin_BTN: RscButton
     {
       ...
       w = 0.05875 * safezoneW;
       h = 0.0235 * safezoneH;
	   onButtonClick = "[] execVM 'code\slotmachine\slots.sqf';";
     };
     class credit1_BTN: RscButton
     {
       ...
       h = 0.0235 * safezoneH;
	   onButtonClick = "[] execVM 'code\slotmachine\add1credit.sqf';";
     };
     class credit10_BTN: RscButton
     {
       ...
       h = 0.0235 * safezoneH;
	   onButtonClick = "[] execVM 'code\slotmachine\add10credit.sqf';";
     };
     class cashout_BTN: RscButton
     {
       ...
       w = 0.05875 * safezoneW;
       h = 0.0235 * safezoneH;
	   onButtonClick = "[] execVM 'code\slotmachine\cashout.sqf';";
     };
   };
};