...
private["_display","_hungerLael","_hungerValue","_thirstLabel","_thirstValue","_healthLabel","_healthValue","_environmentTemperatureLabel","_environmentTemperatureValue","_bodyTemperatureLabel","_bodyTemperatureValue", "_showStatsHud"];

if (_showStatsHud == false) exitWith {false};
