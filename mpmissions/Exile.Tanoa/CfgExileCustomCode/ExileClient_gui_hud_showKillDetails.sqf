...
private["_messages","_overallRespectChange","_messageContent","_scoreName","_scoreString","_scoreStringPad","_i", "_showKillDetails"];

if (_showKillDetails == false) exitWith {false};
